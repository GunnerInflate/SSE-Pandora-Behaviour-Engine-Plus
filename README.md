...
### Download the [latest release here.](https://github.com/GunnerInflate/SSE-Pandora-Behaviour-Engine-Plus/releases/download/v4.3.2-beta/Pandora_Behaviour_Engine_v4.3.3-beta.zip)
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Sets the path to the game directory (the root folder containing the .exe, not the data folder!). Intended for users with Wabbajack "<a ">Stock Game</a>" setup or with multiple installations.</td>
        </tr>
    </tbody>
</table>
